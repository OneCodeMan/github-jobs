...
//        }
    ...
    private func setupView() {
        ...
        let fullTimeCheckbox = BEMCheckBox()
    ...
    @objc func searchButtonClicked() {
        ...
        print(jobTitle, jobLocation, isFullTime)
...
extension JobsViewController: BEMCheckBoxDelegate {
    func didTap(_ checkBox: BEMCheckBox) {
        isFullTime = checkBox.on ? true : false
    }
}
